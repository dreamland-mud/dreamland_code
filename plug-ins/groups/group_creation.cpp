...
{ 
    ...
    act("%1$^C1 взмахивает руками и создает %3$C4.",ch,0,light,TO_ROOM);
    act("Ты взмахиваешь руками и создаешь %3$O4.",ch,0,light,TO_CHAR);
}
...
{ 
    ...
    if (ch->getProfession( )->getFlags( ch ).isSet(PROF_DIVINE)) {
        act("%1$^C1 взмахивает руками, и с неба падает %3$C1.", ch, 0, mushroom,TO_ROOM);
        act("Ты взмахиваешь руками, и с неба падает %3$O1.", ch, 0, mushroom,TO_CHAR);
    }
    else {
        act("%1$^C1 взмахивает руками и создает %3$C4.", ch, 0, mushroom,TO_ROOM);
        act("Ты взмахиваешь руками и создаешь %3$O4.", ch, 0, mushroom,TO_CHAR);
    }
}
...
{ 
    ...
    if (!rose->getRealShortDescr( )) {
        act("%1$^C1 взмахивает руками и создает прекрасную %3$C4.", ch, 0, rose,TO_ROOM);
        act("Ты взмахиваешь руками и создаешь прекрасную %3$O4.", ch, 0, rose,TO_CHAR);
    }
    else {
        act("%1$^C1 взмахивает руками и создает %3$C4.", ch, 0, rose,TO_ROOM);
        act("Ты взмахиваешь руками и создаешь %3$O4.", ch, 0, rose,TO_CHAR);
    }
}
...
{ 
    ...
    act("%3$^O1 пробивается сквозь землю.", ch, 0, spring,TO_ALL);
}
...
{ 
    ...
    {
        act("Ты не можешь снять %3$O4.",ch,0,floating,TO_CHAR);
        return;
    }
    ...
    if (!disc->getRealShortDescr( )) {
        ...
        act("%1$^C1 взмахивает руками и создает %3$C4.", ch, 0, disc,TO_ROOM);
        act("Ты взмахиваешь руками и создаешь %3$O4.", ch, 0, disc,TO_CHAR);
    }
