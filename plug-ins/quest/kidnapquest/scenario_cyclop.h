/* $Id: scenario_cyclop.h,v 1.1.2.2.18.1 2007/09/29 19:34:03 rufina Exp $
 *
 * ruffina, 2004
 */
#ifndef __KIDNAPCYCLOPSCENARIO_H__
#define __KIDNAPCYCLOPSCENARIO_H__

#include "scenario.h"

class KidnapCyclopScenario: public KidnapScenario {
XML_OBJECT
public:
