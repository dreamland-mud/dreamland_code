/* $Id: scenario_bidon.h,v 1.1.2.5.18.1 2007/09/29 19:34:03 rufina Exp $
 *
 * ruffina, 2004
 */
#ifndef __KIDNAPBIDONSCENARIO_H__
#define __KIDNAPBIDONSCENARIO_H__

#include "scenario.h"

class KidnapBidonScenario : public KidnapScenario {
XML_OBJECT
public:
