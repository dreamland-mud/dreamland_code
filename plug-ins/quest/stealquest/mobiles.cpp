...
void RobbedVictim::givenGood( PCharacter *hero, Object *obj )
{
    ...
    say_act( hero, ch, _("Вернись за вознаграждением к тому, кто рассказал тебе о моем несчастье.") );
...
{
    say_act( hero, ch, _("Ну и зачем мне это?") );
...
void RobbedVictim::talkToHero( PCharacter *hero )
{
    ...
    case QSTAT_INIT:
            ...
            tell_raw( hero, ch, _("Верни мне украденное! Жду с нетерпением.") );
